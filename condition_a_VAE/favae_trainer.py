...
hyper_parameters = {'FAVAE': {"prune": 1, "myKc": 100, "pruning_crit": 1e-3, "max_it": 100, "latentspace_lr": args.lr}}
...
FAVAE_model.fit(celeba_in, attributes,
            max_iter=hyper_parameters['FAVAE']['max_it'], # Number maximum of iterations till convergence
